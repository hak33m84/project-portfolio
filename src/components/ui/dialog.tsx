...
function DialogBody({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-base-black h-68 shrink-0 rounded-2xl border border-neutral-800 px-6 pt-20 pb-6 md:h-71.5 md:px-8 md:pb-8',
        className
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        'text-lg-semibold md:text-xl-semibold text-neutral-25 mt-6 text-center',
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        'text-sm-regular md:text-md-regular mt-2 text-center text-neutral-400',
        className
      )}
      {...props}
    />
